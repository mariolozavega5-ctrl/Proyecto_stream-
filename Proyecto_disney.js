...
const DB = {
    ...
    { 
        ...
        trailer: "xbqNb2PFKKA",
        bg: "https://m.media-amazon.com/images/S/pv-target-images/fa328f5427536c62b0e9c064b9999d5ae49f5f52203f2cdf0d4d4916f544469e._SX1080_FMjpg_.jpg",
...
const movieScrollLeft = document.querySelector('.movie-scroll-left');
const movieScrollRight = document.querySelector('.movie-scroll-right');
...
if (movieDisplayGrid && movieScrollLeft && movieScrollRight) {
    movieScrollLeft.onclick = () => desplazarPeliculas(-1);
    movieScrollRight.onclick = () => desplazarPeliculas(1);
}
...
function pintarCollageDestacado(set) {
    ...
    if (!collage || !kicker || !title || !text || !banner) return;
    ...
    // Diccionario de GIFs animados para el fondo del banner
    const bgGifs = {
        "MARVEL": "url('https://i.makeagif.com/media/8-09-2017/hpf7oy.gif')",
        "PIXAR": "url('https://i.pinimg.com/originals/98/29/af/9829af2048f945057b94de4c156b3d0b.gif')",
        "STAR WARS": "url('https://media0.giphy.com/media/v1.Y2lkPTZjMDliOTUyY2x2ZmhhajZlNjk3OXduaHFoaWRqZ3gyOXdyamNuemU0N3JlNXJ3NyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/9E7kUhnT9eDok/giphy.gif')",
        "SERIES": "url('https://i.pinimg.com/originals/71/4e/ab/714eab577d0c6c56efa4254f43717ac7.gif')" 
    };

    // Actualiza el fondo combinando un degradado oscuro con el GIF
    const gifSeleccionado = bgGifs[set.categoria] || 'none';
    banner.style.backgroundImage = `linear-gradient(90deg, rgba(9, 12, 22, 1) 15%, rgba(9, 12, 22, 0.8) 50%, rgba(9, 12, 22, 0.2) 100%), ${gifSeleccionado}`;
...
function desplazarPeliculas(direccion) {
    if (!movieDisplayGrid) return;

    const distancia = Math.max(movieDisplayGrid.clientWidth * 0.85, 320);
    movieDisplayGrid.scrollBy({
